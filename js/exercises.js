...
const createListGroupItems = (postList) => {
  let listTemplate = "";
  postList.forEach((post, index) => {
    ...
    <a href="#" class="list-group-item list-group-item-action" aria-current="true">
      <div class="d-flex w-100 justify-content-between">
        ...
        <small>${index + 1} ${index < 1 ? "day" : "days"} ago</small>
      </div>
...
const executeListGroupCreation = () => {
  let template = createListGroupItems(posts);

  document.querySelector("#lista__posts").innerHTML = template;
};

document.addEventListener("DOMContentLoaded", executeListGroupCreation);
